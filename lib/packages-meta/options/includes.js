...
module.exports = {
	"@kakkuk/serverless-aws-apigateway-documentation": {
		repoUrl: "git@github.com:medikoo/serverless-aws-apigateway-documentation.git"
	},
	"@serverless/aws-dynamodb": {
		repoUrl: "git@github.com:serverless-components/aws-dynamodb.git"
	},
	"@serverless/aws-lambda-otel-extension": {
		multiPackageRepoName: "serverless/console",
		path: "node/packages/aws-lambda-otel-extension"
	},
	"@serverless/aws-lambda-otel-extension-dist": {
		multiPackageRepoName: "serverless/console",
		path: "node/packages/aws-lambda-otel-extension-dist",
		branch: "main"
	},
	"@serverless/aws-lambda-sdk": {
		multiPackageRepoName: "serverless/console",
		path: "node/packages/aws-lambda-sdk"
	},
	"@serverless/cli": { repoUrl: "git@github.com:serverless/cli.git" },
	"@serverless/cloud": { multiPackageRepoName: "serverlessinc/cloud", path: "cli" },
	"@serverless/components": { repoUrl: "git@github.com:serverless/components.git" },
	"@serverless/core": { repoUrl: "git@github.com:serverless/components.git", branch: "v1" },
	"@serverless/enterprise-plugin": {
		repoUrl: "git@github.com:serverless/dashboard-plugin.git",
		branch: "v4"
	},
	"@serverless/event-mocks": { repoUrl: "git@github.com:serverless/event-mocks.git" },
	"@serverless/dashboard-plugin": { repoUrl: "git@github.com:serverless/dashboard-plugin.git" },
	...
	"@serverless/platform-client": { multiPackageRepoName: "serverlessinc/platform", path: "sdk" },
	"@serverless/platform-sdk": { repoUrl: "git@github.com:serverless/platform-sdk.git" },
	"@serverless/safeguards-plugin": { repoUrl: "git@github.com:serverless/safeguards-plugin.git" },
	"@serverless/sdk": { multiPackageRepoName: "serverless/console", path: "node/packages/sdk" },
	"@serverless/sdk-schema": {
		multiPackageRepoName: "serverless/console",
		path: "node/packages/sdk-schema",
		branch: "main"
	},
	...
	"@serverless/typescript": { repoUrl: "git@github.com:serverless/typescript.git" },
	...
	"ext": { repoUrl: "git@github.com:medikoo/es5-ext.git", branch: "ext" },
	"querystring": { repoUrl: "git@github.com:Gozala/querystring.git" },
	...
	"serverless-offline": { repoUrl: "git@github.com:dherault/serverless-offline.git" },
	"serverless-plugin-chrome": {
		multiPackageRepoName: "medikoo/serverless-chrome",
		path: "packages/serverless-plugin"
	},
	"serverless-plugin-stage-variables": {
		repoUrl: "git@github.com:svdgraaf/serverless-plugin-stage-variables.git"
	},
	"serverless-pseudo-parameters": {
		repoUrl: "git@github.com:svdgraaf/serverless-pseudo-parameters.git"
	},
	"serverless-tencent": { repoUrl: "git@github.com:serverless/serverless-tencent.git" },
