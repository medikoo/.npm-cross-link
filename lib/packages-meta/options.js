...
module.exports.allowedForks = [
	"serverless-apigwy-binary", "serverless-domain-manager", "serverless-dotenv-plugin",
	"serverless-iam-roles-per-function", "serverless-plugin-typescript", "serverless-plugin-warmup",
	"serverless-prune-plugin", "serverless-python-requirements", "serverless-ssm-fetch",
	"serverless-step-functions", "serverless-webpack", "serverless-wsgi"
];
